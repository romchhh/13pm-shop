...
export default function NotFoundPage() {
  return (
    <div className="flex min-h-[calc(100dvh-var(--site-header-offset))] w-full items-center justify-center bg-[#F2F2F0] px-6 py-10 text-[#1C1C1C]">
      <div className="w-full max-w-5xl relative">
        <div aria-hidden className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-32 -left-24 w-[420px] h-[420px] rounded-full bg-[#1C1C1C]/10 blur-3xl" />
        ...
        <div className="relative rounded-3xl border border-[#1C1C1C]/10 bg-white/60 backdrop-blur p-6 sm:p-10 shadow-sm">
          <div className="flex flex-col lg:flex-row gap-10 items-center lg:items-start">
            <div className="flex-1 text-center lg:text-left">
              <p className="inline-flex items-center gap-2 text-xs sm:text-sm font-['Montserrat'] uppercase tracking-wider text-[#1C1C1C]/70">
                <span className="inline-block w-2 h-2 rounded-full bg-[#1C1C1C] opacity-80" />
              ...
              <div className="mt-4 space-y-3">
                ...
                <p className="text-base sm:text-lg font-['Montserrat'] text-[#1C1C1C]/75 leading-relaxed">
            ...
            <div className="w-full lg:w-[420px]">
              <div className="rounded-2xl border border-[#1C1C1C]/10 bg-white/70 p-5">
                <p className="text-sm font-['Montserrat'] uppercase tracking-wider text-[#1C1C1C]/70">
                  Швидкі дії
                </p>
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <Link
                    href="/catalog"
                    className="px-5 py-3 bg-[#1C1C1C] text-[#F2F2F0] font-['Montserrat'] font-medium text-sm uppercase tracking-wider hover:bg-[#2d1200] transition-colors rounded-full inline-flex items-center justify-center"
                  >
                    Каталог
                  </Link>
                  <Link
                ...
                <div className="mt-4 rounded-xl bg-[#D7D799]/25 border border-[#D7D799]/40 p-4">
                  <p className="text-sm font-['Montserrat'] text-[#1C1C1C]">
                    Код: <span className="font-semibold">404</span>
                  </p>
                  <p className="text-xs sm:text-sm font-['Montserrat'] text-[#1C1C1C]/70 leading-relaxed mt-1">
