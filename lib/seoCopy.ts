...
export const seoCopy = {
  ...
  delivery: {
    ...
    description: `Доставка та оплата в ${SITE_STORE_NAME}: Нова Пошта по Україні та світу, післяоплата, картка, Apple Pay, Google Pay. Терміни, тарифи, безкоштовна доставка від 2000 ₴.`,
    imageAlt: `Доставка та оплата — ${SITE_STORE_NAME}`,
  },
  returns: {
    title: "Повернення та обмін",
    description: `Повернення та обмін тактичного одягу ${SITE_STORE_NAME}: 14 днів, умови, післяоплата, права споживача згідно із законодавством України.`,
  ...
  checkout: {
    ...
    description: `Оформлення замовлення тактичного одягу ${SITE_STORE_NAME}: доставка Нова Пошта, оплата онлайн або післяоплата.`,
  },
  privacy: {
